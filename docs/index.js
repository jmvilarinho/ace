...
function getTemperaturanDatos(data, element, latitude, longitude) {
	...
	const keyDiv = document.createElement('div');
	keyDiv.innerHTML = `<a href="https://maps.google.com/?q=${latitude},${longitude}&z=8" target="mapa">Temperatura actual ` + data["current"]["temperature_2m"] + "&deg;</a> - <a href=https://waze.com/ul?ll="+latitude+","+longitude+"&z=10><img src=img/waze.png height='15px'></a>";
